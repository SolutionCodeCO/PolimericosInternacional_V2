    ...
    return (
        ...
        {/* backgroud */}
           { isSideMenuOpen && (
            ...
            <div className="fixed top-0 lef-0 w-screen h-screen z-10 bg-black opacity-30">
           ...
           isSideMenuOpen &&(
            ...
            <nav className={
                clsx(
                    "fixed p-5 right-0 top-0 w-[350px] h-screen bg-black z-20 shadow-2xl transform transition-all duration-300",
                    {
